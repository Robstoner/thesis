...
\subsection{Testarea și Validarea API-ului}

În vederea asigurării calității și a robusteții funcționale a API-ului, s-a aplicat o metodologie de testare riguroasă. Pentru aceasta, s-a utilizat clientul REST Bruno \cite{Bruno}, o soluție modernă care permite definirea testelor într-un format declarativ și versionarea acestora alături de codul sursă. Suita de teste implementată a fost proiectată pentru a acoperi în mod exhaustiv toate endpoint-urile critice ale aplicației. Scenariile au validat întregul ciclu de viață al autentificării și gestiunii utilizatorilor, inclusiv securitatea token-urilor JWT, precum și toate operațiunile fundamentale de tip CRUD (Create, Read, Update, Delete) pentru alimente. De asemenea, au fost testate funcționalitățile avansate, precum sistemele de filtrare și ranking. Această abordare structurată, organizată în colecții, a constituit un element cheie în dezvoltarea iterativă și a facilitat detectarea timpurie a regresiilor, garantând astfel stabilitatea și fiabilitatea API-ului pe parcursul întregului proces de dezvoltare.
