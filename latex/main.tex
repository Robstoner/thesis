...
% Metadate
\title{Aplicație mobilă pentru recunoașterea și interpretarea informațiilor nutriționale folosind OCR și analiză a ingredientelor}
...
\include{3-dezvoltare}
\include{4-concluzii}

\include{5-anexa-capturi}
