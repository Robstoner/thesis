...
\begin{itemize}
    \item Dezvoltarea unui sistem integrat care combină OCR-ul pentru limba română și engleză cu procesarea inteligentă a limbajului natural
    \item Implementarea unui algoritm de evaluare a gradului de procesare a alimentelor bazat pe analiza ingredientelor
    \item Crearea unei arhitecturi scalabile folosind tehnologii moderne (FastAPI, PostgreSQL, Docker)
    \item Demonstrarea fezabilității utilizării modelelor de limbaj pentru interpretarea informațiilor nutriționale în limba română
\end{itemize}
...
\begin{itemize}
    ...
    \item Transparența privind sursa informațiilor (AI vs. date oficiale)
\end{itemize}